...
▐   ▀▀▀▀▀▀▀▀▀▀▀";
        ...
        public string CreateProgressBar(double fractionalPercent)
        {
            ...
            var middleSection = $"{new string(FullBlock, (int) fullBlocks)}{new string(HalfBlock, (int) halfBlocks)}{EmptySection.Substring((int)(fullBlocks+halfBlocks))}";
            var resp = string.Format(SyringeFormat, middleSection);
